...
parser = ArgumentParser('icarus.generate.population', description=desc, add_help=False)
...
homepath = path('')
logpath = path('logs/generate_population.log')
...
if not population.ready():
    log.error('Dependent data not parsed or generated.')
    exit(1)

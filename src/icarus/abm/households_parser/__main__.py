...
from icarus.abm.households_parser.parser import HouseholdsParser

parser = ArgumentParser(prog='HouseholdsParser',
    description='Parse ABM households CSV file into table in a SQL database.')
parser.add_argument('--config', type=str,  dest='config',
    default=resource_filename('icarus', 'abm/households_parser/config.json'),
...
try:
    ...
    parser = HouseholdsParser(database, encoding)
